...
-- ----------------------------
INSERT INTO `tb_disk_file` VALUES (18, 1617169131327459329, '1', 'Default.rdp', 'root', 2, 2, NULL);
INSERT INTO `tb_disk_file` VALUES (19, 1617169131327459329, '2', '文件夹3', 'root', 2, 2, NULL);
INSERT INTO `tb_disk_file` VALUES (20, 1617169131327459329, '3', '江茂明-后端开发笔试题.docx', 'yhhsems1cnx8aluj10za9djg8ufwosrpe701nlje', 1, 2, NULL);
INSERT INTO `tb_disk_file` VALUES (21, 1617169131327459329, '4', '文件夹2', '2', 2, 2, NULL);
INSERT INTO `tb_disk_file` VALUES (22, 1617169131327459329, 'yhhsems1cnx8aluj10za9djg8ufwosrpe701nlje', '文件夹1', '4', 2, 2, NULL);
...
CREATE TABLE `tb_share`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1629476827956600834 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '分享表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `tb_share_item`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 5 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '分享item' ROW_FORMAT = Dynamic;
...
CREATE TABLE `test_user`  (
  `t_id` varchar(11) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `test_user` VALUES ('1', 'root');
INSERT INTO `test_user` VALUES ('2', '1');
INSERT INTO `test_user` VALUES ('3', 'root');
INSERT INTO `test_user` VALUES ('4', '2');
INSERT INTO `test_user` VALUES ('5', '4');
