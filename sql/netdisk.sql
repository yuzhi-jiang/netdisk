...
) ENGINE = InnoDB AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '数据字典表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_log`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 661 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统日志' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of sys_log
-- ----------------------------
INSERT INTO `sys_log` VALUES (647, NULL, '', 'com.yefeng.account.controller.UserController.getinfo()', NULL, 3, '0:0:0:0:0:0:0:1', '2023-01-15 16:52:14');
INSERT INTO `sys_log` VALUES (648, NULL, '测试获取信息', 'com.yefeng.account.controller.UserController.getinfo()', '\"123\"', 5, '127.0.0.1', '2023-01-15 17:24:15');
INSERT INTO `sys_log` VALUES (649, NULL, '测试获取信息', 'com.yefeng.account.controller.UserController.getinfo()', '\"asdf\"', 6, '0:0:0:0:0:0:0:1', '2023-01-16 14:08:07');
INSERT INTO `sys_log` VALUES (650, NULL, '测试获取信息', 'com.yefeng.account.controller.UserController.getinfo()', '\"asdf\"', 0, '127.0.0.1', '2023-01-16 14:09:26');
INSERT INTO `sys_log` VALUES (651, NULL, '测试获取信息', 'com.yefeng.account.controller.UserController.getinfo()', '\"asdf\"', 0, '0:0:0:0:0:0:0:1', '2023-01-16 14:12:03');
INSERT INTO `sys_log` VALUES (652, NULL, '测试获取信息', 'com.yefeng.account.controller.UserController.getinfo()', '\"asdf123\"', 0, '0:0:0:0:0:0:0:1', '2023-01-16 14:12:07');
INSERT INTO `sys_log` VALUES (653, NULL, '测试获取信息', 'com.yefeng.account.controller.UserController.getinfo()', '\"sss\"', 0, '127.0.0.1', '2023-01-16 14:12:42');
INSERT INTO `sys_log` VALUES (654, NULL, '测试获取信息', 'com.yefeng.account.controller.UserController.getinfo()', '\"asdf\"', 5, '0:0:0:0:0:0:0:1', '2023-01-16 14:14:38');
INSERT INTO `sys_log` VALUES (655, NULL, '测试获取信息', 'com.yefeng.account.controller.UserController.getinfo()', '\"5555\"', 84, '0:0:0:0:0:0:0:1', '2023-01-16 14:20:53');
INSERT INTO `sys_log` VALUES (656, NULL, '测试获取信息', 'com.yefeng.account.controller.UserController.getinfo()', '\"5555\"', 3, '0:0:0:0:0:0:0:1', '2023-01-16 14:25:17');
INSERT INTO `sys_log` VALUES (657, NULL, '测试获取信息', 'com.yefeng.account.controller.UserController.getinfo()', '\"5555\"', 5, '0:0:0:0:0:0:0:1', '2023-01-16 14:27:41');
INSERT INTO `sys_log` VALUES (658, '1234324:yefeng', '测试获取信息', 'com.yefeng.account.controller.UserController.getinfo()', '\"5555\"', 4, '0:0:0:0:0:0:0:1', '2023-01-16 14:33:26');
INSERT INTO `sys_log` VALUES (659, 'null:null', '测试获取信息', 'com.yefeng.netdisk.front.controller.UserController.getinfo()', '\"12\"', 6, '0:0:0:0:0:0:0:1', '2023-01-18 19:59:52');
INSERT INTO `sys_log` VALUES (660, 'null:null', '测试获取信息', 'com.yefeng.netdisk.front.controller.UserController.getinfo()', '\"\"', 2, '0:0:0:0:0:0:0:1', '2023-01-18 20:29:56');
INSERT INTO `sys_log` VALUES (661, 'null:null', '测试获取信息', 'com.yefeng.netdisk.front.controller.UserController.getinfo()', '\"12\"', 5, '0:0:0:0:0:0:0:1', '2023-01-18 21:21:18');
...
CREATE TABLE `sys_notice`  (
  ...
  `create_user` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '登录者',
  `create_time` bigint(20) NULL DEFAULT NULL COMMENT '登录时间',
  `op_user` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '更新者',
  `op_time` bigint(20) NULL DEFAULT NULL COMMENT '更新时间',
  `last_ver` smallint(6) NOT NULL DEFAULT 0 COMMENT '版本号',
  `remark` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT '' COMMENT '备注',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '通知公告表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `sys_role_menu`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1498 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '角色与菜单对应关系' ROW_FORMAT = Dynamic;
...
CREATE TABLE `tb_disk`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1617169131327459329 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of tb_disk
-- ----------------------------
INSERT INTO `tb_disk` VALUES (1617169131327459329, 22, 524288030, -40);
...
-- ----------------------------
INSERT INTO `tb_disk_file` VALUES (5, 1617169131327459329, '3', 'xsync', 'root', 1, NULL, 3);
INSERT INTO `tb_disk_file` VALUES (6, 1617169131327459329, '5', 'Default.rdp', 'root', 1, NULL, 5);
INSERT INTO `tb_disk_file` VALUES (7, 1617169131327459329, '6', '22dddc962d4ea10b9aaf6c67832c05e7.pdf', 'root', 1, NULL, 6);
INSERT INTO `tb_disk_file` VALUES (8, 1617169131327459329, '7', '江茂明-后端开发笔试题.docx', 'root', 1, NULL, 7);
INSERT INTO `tb_disk_file` VALUES (9, 1617169131327459329, '9', '[1975][10月]聪明 目录.xlsx', 'root', 1, NULL, 9);
INSERT INTO `tb_disk_file` VALUES (10, 1617169131327459329, '10', '天池比赛入门与实践 - AI学习 - 阿里云天池_3.ts', 'root', 1, NULL, 10);
INSERT INTO `tb_disk_file` VALUES (13, 1617169131327459329, 'yhhsems1cnx8aluj10za9djg8ufwosrpe701nlje', 'xsync', 'root', 1, 3, 11);
INSERT INTO `tb_disk_file` VALUES (14, 1617169131327459329, 't7b41qf05p5qdjfnsy9r8m464egpvj2k0t48xxhs', '1.jpg', 'root', 1, 2, 12);
INSERT INTO `tb_disk_file` VALUES (15, 1617169131327459329, 'en3b3xw4865nu76vcqaw9ud0rig5t67j27qnf7nd', 'Default.rdp(2)', 'root', 1, 3, 12);
INSERT INTO `tb_disk_file` VALUES (16, 1617169131327459329, '5uwe91mdd24tuauq5pjom0ulp9k6eg25txtlp4mq', 'Default.rdp(3)', 'root', 1, 3, 12);
...
-- ----------------------------
INSERT INTO `tb_disk_item` VALUES (4, 1617169131327459329, '基础容量', 524288000, -1);
...
-- Records of tb_file
-- ----------------------------
INSERT INTO `tb_file` VALUES (1, '-1', '2', '3', '/yefng', '216', 1, 'sdafsadf', 1, '');
INSERT INTO `tb_file` VALUES (2, NULL, '《顶盒免费固件大全合集分享》 .txt', '《顶盒免费固件大全合集分享》 .txt', '/', '767', 1, 'e2ccff1f4b7e8cd3269f2852dbd4b8f3', NULL, '');
INSERT INTO `tb_file` VALUES (3, NULL, 'xsync', 'xsync', '/22', '529', 1, '25bdcdc1c48bbef30ce5ffaefa88784b', NULL, '');
INSERT INTO `tb_file` VALUES (5, NULL, 'Default.rdp', 'Default.rdp', '/1617169131327459329', '2288', 1, 'd88c857cd87a84f82c4a966ffdd1bf4f', NULL, '');
INSERT INTO `tb_file` VALUES (6, NULL, '22dddc962d4ea10b9aaf6c67832c05e7.pdf', '22dddc962d4ea10b9aaf6c67832c05e7.pdf', '/1617169131327459329', '153453', 1, '3180d187b2f28d05bee7cfe68d92e915', NULL, '');
INSERT INTO `tb_file` VALUES (7, NULL, '江茂明-后端开发笔试题.docx', '江茂明-后端开发笔试题.docx', '/1617169131327459329', '135918', 1, 'aaddc0670ae374560e036aad03e6c873', NULL, '');
INSERT INTO `tb_file` VALUES (8, NULL, '留言板系统.xmind', '留言板系统.xmind', '/1617169131327459329', '156820', 1, '7464c268815dea93dbf34f3286d04f92', NULL, '');
INSERT INTO `tb_file` VALUES (9, NULL, '[1975][10月]聪明 目录.xlsx', '[1975][10月]聪明 目录.xlsx', '/1617169131327459329', '2676607', 1, '2690ef813c14dd055d31a6389adbbbf8', NULL, '');
INSERT INTO `tb_file` VALUES (10, NULL, '天池比赛入门与实践 - AI学习 - 阿里云天池_3.ts', '天池比赛入门与实践 - AI学习 - 阿里云天池_3.ts', '/1617169131327459329', '94668716', 1, 'f3ddc61438b81aef951ecc6dc0beaaec', NULL, '');
INSERT INTO `tb_file` VALUES (11, 'c8cum35ekrgbzyyxsdwoi0tlxcw3mkya7q49rkay', 'xsync', 'xsync', '/yefeng', '529', 1, '520a91c059cd57f9d88a52f349e4f90d37921ab0', 1, 'qyvqsuhoytsi2qe4zjcbaxeafehxhf2b');
INSERT INTO `tb_file` VALUES (12, 'vcd9g16a255cfwv3ohsjuvu78p643j8namr8fj99', '1.jpg', '1.jpg', '/yefeng', '2288', 1, 'df0d35eb674915c363b700fe075b588778de3394', 1, 'txjfi1qsdn1dlavtd9hbn95defaq437d');
...
-- Records of tb_share
-- ----------------------------
INSERT INTO `tb_share` VALUES (1629428596883116034, 1617169131327459329, 'xsync等文件', 'xsync等文件', NULL, 0, '', 1);
INSERT INTO `tb_share` VALUES (1629430008849420290, 1617169131327459329, 'xsync', 'xsync', '2023-02-18T10:54:56Z', 1, '', 1);
INSERT INTO `tb_share` VALUES (1629476225310613505, 1617169131327459329, '江茂明-后端开发笔试题.docx', '江茂明-后端开发笔试题.docx', '2023-02-17T10:54:56Z', 1, '', 1);
INSERT INTO `tb_share` VALUES (1629476827956600834, 1617169131327459329, '天池比赛入门与实践 - AI学习 - 阿里云天池_3.ts', '天池比赛入门与实践 - AI学习 - 阿里云天池_3.ts', '2023-02-17T10:54:56Z', 1, '', 1);
...
CREATE TABLE `tb_share_item`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `file_id` bigint(20) NULL DEFAULT NULL COMMENT '分享的文件id（个人云盘的fileid）',
  `share_id` bigint(20) NULL DEFAULT NULL COMMENT '分享id',
  `type` int(11) NULL DEFAULT NULL COMMENT '文件类型',
  `disk_id` bigint(20) NULL DEFAULT NULL COMMENT '网盘id',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '分享item' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of tb_share_item
-- ----------------------------
INSERT INTO `tb_share_item` VALUES (1, 3, 1629428596883116034, 1, 1617169131327459329);
INSERT INTO `tb_share_item` VALUES (2, 5, 1629428596883116034, 1, 1617169131327459329);
INSERT INTO `tb_share_item` VALUES (3, 3, 1629430008849420290, 1, 1617169131327459329);
INSERT INTO `tb_share_item` VALUES (4, 7, 1629476225310613505, 1, 1617169131327459329);
INSERT INTO `tb_share_item` VALUES (5, 10, 1629476827956600834, 1, 1617169131327459329);
...
-- Records of tb_user
-- ----------------------------
INSERT INTO `tb_user` VALUES (22, NULL, NULL, '$2a$10$KHYbRMoOlvkjOnDdD/7S0.', NULL, '18312847020', NULL, NULL);
