package com.yefeng.netdisk.common.aspect;

import com.fasterxml.classmate.TypeResolver;
import com.google.common.base.Optional;
import com.yefeng.netdisk.common.annotation.ApiJsonObject;
import com.yefeng.netdisk.common.annotation.ApiJsonProperty;
import javassist.*;
...
public class MapReaderForApi implements ParameterBuilderPlugin {
	...
	private final static String basePackage = "com.yefeng.netdisk"; // 动态生成的虚拟DTO Class的包路径
